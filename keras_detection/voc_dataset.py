...
def get_data(input_path):
    data = pd.DataFrame(columns=['Frame','xmin','xmax','ymin','ymax','label','type'])
    all_imgs = []
        ...
        for annot in annots:
            try:
                ...
                for element_obj in element_objs:
                    ...
                    data2 = {'Frame':element_filename,'xmin':x1,'xmax':x2,'ymin':y1,'ymax':y2,'label':class_mapping[class_name], 'type':annotation_data['imageset']}
